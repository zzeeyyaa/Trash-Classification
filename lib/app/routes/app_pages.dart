...
import '../modules/camera_detector/bindings/camera_detector_binding.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(
      name: _Paths.CAMERA_DETECTOR,
      page: () => const CameraDetectorView(),
      binding: CameraDetectorBinding(),
    ),
    GetPage(
      name: _Paths.LOGIN,
